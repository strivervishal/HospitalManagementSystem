  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        <Sidebar />
        <div className="flex-1 p-8 bg-gray-100 ml-60 mt-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">Help Center</h2>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <p>Email: <a href="mailto:support@hospital.com" className="text-teal-500 font-medium mailto:hover:underline">support@hospital.com</a></p>
            <p>Phone: <span className="text-teal-500 font-medium">+1 234 567 890</span></p>
          </div>
        </div>
      </div>
    </div>
